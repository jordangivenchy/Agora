...
/* Everything asks for the pass while the beta is closed — reading
   included. Opening a door for readers is src/lib/readingGate.ts away:
   it holds the list of what would open and the check that uses it, and
   the archive, sitemap and robots.txt it was written for are already
   here, waiting for the day that's wanted. */
