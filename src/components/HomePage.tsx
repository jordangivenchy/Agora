...
import { fetchFeatured, fetchHeroRooms, fetchNavUser, type FeaturedNote, type HomeInitial } from "@/lib/homeData";
...
export default function HomePage({ initial }: { initial: HomeInitial }) {
  ...
  const [featured, setFeatured] = useState<FeaturedNote[]>(initial.featured);
