/* Community bookmarks, the site's format (src/lib/communityBookmarks.ts):
   the text moderators edit and the JSON the community page renders.
...
/** Trust nothing about jsonb from the database. */
